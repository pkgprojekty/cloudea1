        ...
        metrics: [
          {
            value: "Board",
            label:
              "Business Capability Map jako wspólny język z zarządem i CIO. Każda organizacja musi mieć swoj model. To jest obraz Company-on-a-page aby móc ocenić aktualny oraz oczekiwany poziom możliwości biznesowych.",
          },
          {
            value: "Data",
            label:
